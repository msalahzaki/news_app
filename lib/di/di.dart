...
import 'package:news_app/ui/home/sources_items/repository/data_source/Sources_remote_data_source.dart';
...
SourcesRepository injectSourceRepository() {
  return SourcesRepositoryImpl(injectSourceDataSource());
}

SourcesDataSource injectSourceDataSource() {
  return SourcesRemoteDataSource(injectApiManger());
}
...
NewsRepository injectNewsReposatory() {
